...
class Predictor:
    def __init__(self, training_data):
        ...
        # files_to_load = [
        #     'saved/unigrams.json', 'saved/bigrams.json', 'saved/trigrams.json', 'saved/fourgrams.json',
        #     'saved/fivegrams.json'
        # ]
    ...
    def initialize_dicts(self, files_to_load, training_data):
        ...
        for path in files_to_load:
            if os.path.exists(path):
                ...
                print("It took {} to load {}-gram file".format(elapsed_time, str(count + 1)))
            else:
    ...
    #                 elif count == 3:
    #                     self.fourgrams = json.load(f)
    #                 elif count == 4:
    #                     self.fivegrams = json.load(f)
    #             end_time = time.time()
    #             elapsed_time = end_time - start_time
    #             print("It took {} to load {}-gram file".format(elapsed_time, str(count + 1)))
    #         else:
    ...
    #                 self.fourgrams = self.generate_ngrams(self.train, 4)
    #                 with open(path, 'w') as f:
    #                     json.dump(self.fourgrams, f)
    #             elif count == 4:
    #                 self.fivegrams = self.generate_ngrams(self.train, 5)
    #                 with open(path, 'w') as f:
    #                     json.dump(self.fivegrams, f)
    #         count = count + 1
